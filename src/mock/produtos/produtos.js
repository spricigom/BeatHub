...
export const MockProducts = [
    ...
    {//guitarras
        id: 11,
        nome: ' Guitarra Masterbuilt John Frusciante Stratocaster',
        preco:  42.00 ,
    ...
    {
        id: 12,
        nome: 'Guitarra Fender® x Hello Kitty® Pink Stratocaster',
        preco: 17.00 ,
        descricao: 'A Fender Hello Kitty Pink Stratocaster é uma guitarra elétrica que combina o design clássico da famosa Stratocaster com um toque único e lúdico inspirado na personagem Hello Kitty, da Sanrio. Lançada como um modelo especial, ela apresenta um acabamento rosa brilhante, com detalhes exclusivos da Hello Kitty, como adesivos e uma imagem da personagem no headstock (a parte superior do braço). Além de seu visual atraente, o modelo mantém a qualidade e o som característicos da Fender, com três captadores single-coil, que proporcionam um som claro e brilhante, ideal para uma ampla gama de estilos musicais, como pop, rock e música alternativa. A Fender Hello Kitty Pink Stratocaster é uma guitarra voltada para fãs da marca, colecionadores e músicos que buscam um instrumento com um design diferenciado, mas com o desempenho e a confiabilidade da Fender.',
        img: 'guitarra2.jpg', 
        img2:'hello1-2.jpg',
    ...
    {
        id: 13,
        nome: 'Guitarra Player II Jazzmaster',
    ...
    {
        id: 14,
        nome: 'Guitarra Jimmy Page Telecaster',
        preco: 50.00 ,
    ...
    {
        id: 15,
        nome: 'Guitarra Kurt Cobain Jaguar® Left-Han',
        preco:  30.00 ,
    ...
    {
        id: 17,
        nome: 'Guitarra Eric Clapton Stratocaster®',
        preco: 69.00 ,
    ...
    {
        id: 18,
        nome: 'Guitarra Jimi Hendrix Stratocaster®',
        preco:  22.00 ,
    ...
    {
        id: 19,
        nome: 'Guitarra H.E.R. Stratocaster®',
        preco:  40.00,
    ...
    {
        id: 20,
        nome: 'Guitarra Tom Morello Stratocaster®',
        preco: 17.00 ,
    ...
    {//baixos
        id: 21,
        nome: 'Baixo American Professional II Precision Bass®',
        preco: 17.00 ,
    ...
    {
        id: 22,
        nome: 'Baixo American Ultra II Meteora® Bass',
        preco: 42.00 ,
    ...
    {
        id: 23,
        nome: 'Baixo Duff McKagan Deluxe Precision Bass®',
        preco: 32.00 ,
    ...
    {
        id: 24,
        nome: 'Baixo Limited Edition Mark Hoppus Jaguar® Bass',
        preco: 24.00 ,
    ...
    {
        id: 25,
        nome: 'Baixo Player Plus Active Jazz Bass®',
        preco:  30.00,
    ...
    {
        id: 27,
        nome: 'Baixo Troy Sanders Precision Bass®',
        preco: 69.00 ,
    ...
    {
        id: 28,
        nome: 'Baixo American Performer Mustang® Bass',
        preco:  50.00,
    ...
    {
        id: 29,
        nome: 'Baixo Classic Vibe 70s Jazz Bass® V',
        preco:  40.00,
    ...
    {//pedais
        id:31,
        nome:'BOSS DS-1W | Pedal de distorção Waza Craft',
        preco: 42.00,
    ...
    {
        id: 32,
        nome:'BOSS MT-2W | Pedal de Distorção Metal Zone Waza Craft',
        preco: 17.00,
    ...
    {
        id: 33,
        nome:'BOSS FZ-1W | Pedal de Fuzz Waza Craft',
        preco: 32.00,
    ...
    {
        id: 34,
        nome:'BOSS CE-2W | Pedal de Chorus Waza Craft',
        preco: 69.00,
        descricao: '',
        img: 'pedal4.webp',
    },
    {
        id: 35,
        nome:'BOSS VB-2W | Pedal de modulação vibrato Waza Craft',
        preco: 22.00,
    ...
    {
        id: 36,
        nome:'Pedal de Reverb Digital BOSS RV-6 Reverb',
        preco: 50.00,
    ...
    {
        id: 37,
        nome:'Pedal de Modulação BOSS TR-2 Tremolo',
        preco: 40.00,
    ...
    {
        id: 38,
        nome:'Pedal de Overdrive/ Distortion BOSS JB-2 Angry Driver',
        preco: 35.00,
    ...
    {
        id: 39,
        nome:'BOSS NS-2 | Pedal Supressor de Ruído',
        preco: 17.00,
    ...
    {
        id: 40,
        nome:'Pedal Harmonizador e Pitch Shifter BOSS PS-6 Harmonist',
        preco: 69.00,
    ...
    {
        id: 54,
        nome: 'Violão Phoenix Nylon NL4BK',
        preco: 24.00,
    ...
    {
        id: 55,
        nome: 'Violão Infantil Vogga VCA85',
        preco: 40.00,
    ...
    {
        id: 66,
        nome: 'Bateria  D-One Rocket DR22', //mudança de nome
        preco:  38.00,
    ...
    {
        id: 69,
        nome: 'Bateria Tagima Nagano Garage Fusion 20', //mudança de nome
        preco:  44.00,
